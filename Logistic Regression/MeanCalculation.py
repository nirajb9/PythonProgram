...
scores = tk.Tk()
scores['bg']='#436fba'
label1 = tk.Label(scores, text="Logistic Regression Assumptions", font=("Arial bold",10)).grid(row=0, columnspan=1)
cols = ('Hours(x)', 'Pass(y)', '〖(x〗_i-x ̅)', '〖(y〗_i-y ̅)', '〖(x〗_i-x ̅)*〖(y〗_i-y ̅)', '〖〖(x〗_i-x ̅)〗^2')
